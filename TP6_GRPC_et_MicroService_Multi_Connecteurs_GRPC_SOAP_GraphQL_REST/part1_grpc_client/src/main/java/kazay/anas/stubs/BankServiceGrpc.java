...
public final class BankServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<kazay.anas.stubs.Bank.ConvertCurrencyRequest,
      kazay.anas.stubs.Bank.ConvertCurrencyResponse> getConvertMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "convert",
      requestType = kazay.anas.stubs.Bank.ConvertCurrencyRequest.class,
      responseType = kazay.anas.stubs.Bank.ConvertCurrencyResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<kazay.anas.stubs.Bank.ConvertCurrencyRequest,
      kazay.anas.stubs.Bank.ConvertCurrencyResponse> getConvertMethod() {
    io.grpc.MethodDescriptor<kazay.anas.stubs.Bank.ConvertCurrencyRequest, kazay.anas.stubs.Bank.ConvertCurrencyResponse> getConvertMethod;
    if ((getConvertMethod = BankServiceGrpc.getConvertMethod) == null) {
      synchronized (BankServiceGrpc.class) {
        if ((getConvertMethod = BankServiceGrpc.getConvertMethod) == null) {
          BankServiceGrpc.getConvertMethod = getConvertMethod = 
              io.grpc.MethodDescriptor.<kazay.anas.stubs.Bank.ConvertCurrencyRequest, kazay.anas.stubs.Bank.ConvertCurrencyResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "BankService", "convert"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  kazay.anas.stubs.Bank.ConvertCurrencyRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  kazay.anas.stubs.Bank.ConvertCurrencyResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<kazay.anas.stubs.Bank.ConvertCurrencyRequest,
      kazay.anas.stubs.Bank.ConvertCurrencyResponse> getGetCurrencyStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<kazay.anas.stubs.Bank.ConvertCurrencyRequest,
      kazay.anas.stubs.Bank.ConvertCurrencyResponse> getGetCurrencyStreamMethod() {
    io.grpc.MethodDescriptor<kazay.anas.stubs.Bank.ConvertCurrencyRequest, kazay.anas.stubs.Bank.ConvertCurrencyResponse> getGetCurrencyStreamMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<kazay.anas.stubs.Bank.ConvertCurrencyRequest,
      kazay.anas.stubs.Bank.ConvertCurrencyResponse> getPerformStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<kazay.anas.stubs.Bank.ConvertCurrencyRequest,
      kazay.anas.stubs.Bank.ConvertCurrencyResponse> getPerformStreamMethod() {
    io.grpc.MethodDescriptor<kazay.anas.stubs.Bank.ConvertCurrencyRequest, kazay.anas.stubs.Bank.ConvertCurrencyResponse> getPerformStreamMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<kazay.anas.stubs.Bank.ConvertCurrencyRequest,
      kazay.anas.stubs.Bank.ConvertCurrencyResponse> getFullCurrencyStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<kazay.anas.stubs.Bank.ConvertCurrencyRequest,
      kazay.anas.stubs.Bank.ConvertCurrencyResponse> getFullCurrencyStreamMethod() {
    io.grpc.MethodDescriptor<kazay.anas.stubs.Bank.ConvertCurrencyRequest, kazay.anas.stubs.Bank.ConvertCurrencyResponse> getFullCurrencyStreamMethod;
  ...
  public static abstract class BankServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void convert(kazay.anas.stubs.Bank.ConvertCurrencyRequest request,
        io.grpc.stub.StreamObserver<kazay.anas.stubs.Bank.ConvertCurrencyResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getConvertMethod(), responseObserver);
    }

    /**
     */
    public void getCurrencyStream(kazay.anas.stubs.Bank.ConvertCurrencyRequest request,
        io.grpc.stub.StreamObserver<kazay.anas.stubs.Bank.ConvertCurrencyResponse> responseObserver) {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<kazay.anas.stubs.Bank.ConvertCurrencyRequest> performStream(
        io.grpc.stub.StreamObserver<kazay.anas.stubs.Bank.ConvertCurrencyResponse> responseObserver) {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<kazay.anas.stubs.Bank.ConvertCurrencyRequest> fullCurrencyStream(
        io.grpc.stub.StreamObserver<kazay.anas.stubs.Bank.ConvertCurrencyResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                kazay.anas.stubs.Bank.ConvertCurrencyRequest,
                kazay.anas.stubs.Bank.ConvertCurrencyResponse>(
  ...
  public static final class BankServiceBlockingStub extends io.grpc.stub.AbstractStub<BankServiceBlockingStub> {
    ...
    /**
     */
    public kazay.anas.stubs.Bank.ConvertCurrencyResponse convert(kazay.anas.stubs.Bank.ConvertCurrencyRequest request) {
    ...
    /**
     */
    public java.util.Iterator<kazay.anas.stubs.Bank.ConvertCurrencyResponse> getCurrencyStream(
        kazay.anas.stubs.Bank.ConvertCurrencyRequest request) {
  ...
  public static final class BankServiceFutureStub extends io.grpc.stub.AbstractStub<BankServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<kazay.anas.stubs.Bank.ConvertCurrencyResponse> convert(
        kazay.anas.stubs.Bank.ConvertCurrencyRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CONVERT:
          serviceImpl.convert((kazay.anas.stubs.Bank.ConvertCurrencyRequest) request,
              (io.grpc.stub.StreamObserver<kazay.anas.stubs.Bank.ConvertCurrencyResponse>) responseObserver);
          break;
        case METHODID_GET_CURRENCY_STREAM:
          serviceImpl.getCurrencyStream((kazay.anas.stubs.Bank.ConvertCurrencyRequest) request,
              (io.grpc.stub.StreamObserver<kazay.anas.stubs.Bank.ConvertCurrencyResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class BankServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return kazay.anas.stubs.Bank.getDescriptor();
    }
